...
from models.models import MERModel, analyze_layer_weights, plot_layer_weights
from losses.losses import CCCLoss, HybridLoss
from utils.data_utils import load_pmemo_data, quadrant_r2_breakdown, add_quadrant_labels
...
def plot_va_scatter(y_true: np.ndarray, y_pred: np.ndarray, save_path: str = "va_scatter.png"):
    ...
    from utils.data_utils import add_quadrant_labels
