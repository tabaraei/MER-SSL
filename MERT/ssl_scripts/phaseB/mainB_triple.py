...
from data_utils_triple import load_pmemo_triple_ssl
from models_triple import TripleSSLModel, SpectrogramOnlyModel
...
def main():
    ...
    ap.add_argument("--feat_path", default="pmemo_mert_all_layers.pt")
    ap.add_argument("--w2v_path",  default="pmemo_wav2vec_all_layers.pt")
    ap.add_argument("--melspec_path", default="pmemo_melspec.pt")
